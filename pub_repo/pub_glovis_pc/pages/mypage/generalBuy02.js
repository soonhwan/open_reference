...
const generalBuy02 = ({router}) => {
  ...
  return (
          ...
          <div className="list-wrap">
            <div className="list-tit">
              ...
              <SelectBox id="select1" className="items-sbox" options={[
                { value: '1', label: '조회 순' },
                { value: '2', label: '가격 순' }
              ]} width={148} height={36} placeHolder="조회 순" />
            </div>
        ...
        <div className="con-wrap popup-comparison">
          ...
          <table className="table-tp1" summary="결제내역에 대한 내용">
            ...
            <tbody>
              ...
              <tr>
                <th className="bg-sky60">총 가격(예상)<Button size="mid" line="gray" radius={true} title="닫기" width={38} height={32} /></th>
                <td>878만원</td>
                <td>878만원</td>
                <td>878만원</td>
                <td>878만원</td>
    ...
                  ]} width={93} height={40} placeHolder="12개월" />
              ...
              <tr>
                <th className="bg-sky60">옵션개수<Button size="mid" line="gray" radius={true} title="닫기" width={38} height={32} /></th>
                <td>16개</td>
                <td>16개</td>
                <td>16개</td>
                <td>16개</td>
