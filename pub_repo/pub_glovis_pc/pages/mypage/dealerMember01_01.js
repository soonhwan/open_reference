      ...
      <div className="content-wrap">
        ...
        <div className="mypage-state-sec member-info-pw">
          ...
          <Buttons align="center" marginTop={48}>
            <Button size="big" background="gray" title="취소" width={127} height={48}/>
            <Button size="big" background="blue80" title="확인" width={127} height={48}/>
          </Buttons>
        </div>
      </div>
    </AppLayout>
...
export default DealerMember01_01