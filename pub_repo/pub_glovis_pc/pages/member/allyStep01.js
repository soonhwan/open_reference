...
import { select_area } from '@src/dummy'
              ...
              <fieldset>
                ...
                <table summary="가입정보입력에 대한 내용" className="table-tp2">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th>
                        <label htmlFor="ally-name">제휴법인명</label>
                      </th>
                      <td>
                        <Input type="text" value="현대모터스" disabled={true} id="ally-name" width={548} />
                      </td>
                    </tr>
                    <tr>
                      <th>
                    ...
                    <tr>
                      ...
                      <td>
                        <InputFile uploadList={uploadList1} />
                        <Button size="mid" background="gray" title="업무제휴계약서 다운로드" width={180} height={48} marginTop={10} />
                      </td>
                    </tr>
                    <tr>
