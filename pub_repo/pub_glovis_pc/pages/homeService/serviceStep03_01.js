...
import { select1_list, radio_group_sign } from '@src/dummy';
import { SECTION_HOME_SERVICE } from '@src/actions/types';

const ServiceStep03_01 = () => {
              ...
              <table summary="개인 계약자 정보에 대한 내용" className="table-tp2 row1">
                ...
                <tbody>
                  <tr>
                    <th>공동명의 여부</th>
                    <td>
                      <CheckBox id='chk-joint-tenancy' title='공동명의' checked={tenancy} onChange={chkTenancy} />
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colSpan="3">
                      ...
                      <span className="bridge">
                        <SelectBox id="bank-name" className="items-sbox" placeHolder="은행명" options={select1_list} width={272} height={48} />
                      </span>
                      <span className="bridge">
...
export default ServiceStep03_01